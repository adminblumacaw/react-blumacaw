  ...
  const plans = [
    {
      ...
      features: [
        ...
        "1 Active Page Lock Rule",
        "50 CSV/XLSX Bulk Uploads Monthly",
        "Unlimited Registration Forms",
        "Manual or Auto-tag and approve customers",
    ...
    },
    {
      ...
      features: [
        ...
        "Min/max order limits by quantity",
        "Min/max order limits by amount",
        "Support multi-currency wholesale pricing",
        "Support Shopify Markets",
        "Unlimited store lock and hide price",
      ],
    },
    {
      name: "Advanced",
