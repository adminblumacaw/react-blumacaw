...
const About = () => {
  const credentials = [
    ...
    },
    {
      ...
      description: "Rated 5.0 out of 5 stars on the Shopify App Store with 20 reviews — 100% are 5 stars"
    },
    {
      icon: Headphones,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              ...
              <p>
                Based in Bangalore, India, and launched in June 2025, we're dedicated to simplifying wholesale operations for Shopify merchants worldwide. Our app is Built for Shopify, works with Shopify Checkout, Customer Accounts, POS, Admin, and Markets, and supports 20 languages.
              </p>
            </div>
